#!/usr/bin/env python3
# qa_vertexai_save_embeddings.py — original RAG + Vertex AI chat + save embeddings
...
PDF_FILES = ["xoxoxox.pdf"]  # replace with your file names
...
# 2) Get embeddings for all chunks (same as original)
...
# 2b) Save embeddings to JSON locally
emb_json = []
...
with open("pdf_chunk_embeddings.json", "w") as f:
    json.dump(emb_json, f, indent=2)
print(f"Saved {len(emb_json)} embeddings to pdf_chunk_embeddings.json")
